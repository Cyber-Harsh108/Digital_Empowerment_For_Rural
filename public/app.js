...
function LoginModal({ open, onClose }) {
  ...
  const [status, setStatus] = useState(null); // message to show (success/error)
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setIsLoggedIn(true);
      setStatus("Login saved in database.");
      setLoading(false);
        ...
        <div className="help-dialog-body">
          {isLoggedIn ? (
            <div style={{ textAlign: "center", padding: "1rem" }}>
              ...
              <p>
                Welcome back,
                <strong> {mobile || "Village User"}</strong>.
              </p>
              <p
                style={{
                  fontSize: "0.9rem",
              ...
              >
                Your login has been recorded in the village system.
              </p>
            ...
            <form onSubmit={handleLogin}>
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? "Saving..." : "Enter My Dashboard"}
              </button>
            </form>
          )}
        </div>
    ...
    <footer className="footer">
      <div className="footer-inner">
        <span>
          ...
          <span className="footer-highlight">Gram Sathi</span>. Made
          for us, by us.
        </span>
